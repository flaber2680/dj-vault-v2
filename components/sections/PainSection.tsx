const processItems = [
  ...
  },
  {
    number: "02",
    title: "Сортировка",
    text: "Раскладываем треки по энергии, жанру и моменту для сета.",
  },
  {
    number: "03",
    title: "Готовый архив",
    text: "Оставляем только материал, который можно быстро открыть и играть.",
  },
];
    ...
    <section className="pain-section" id="how-it-works">
      ...
      <div className="pain-top">
        ...
        <div className="pain-summary">
          ...
          <p>
            DJ Vault каждую неделю превращает поток новых релизов в короткий,
            понятный и пригодный для игры архив.
          </p>
